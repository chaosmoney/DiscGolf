...
{
    public TMP_Text fpsText;        //프레임 
    public TMP_Text reservedMemoryText; //가용 메모리 양 
    public TMP_Text allocMemoryText;    //사용하고있는 메모리양 
    public TMP_Text unusedReservedMemory; //남은 메모리 양 
