...
namespace Oculus.Interaction
{
    public class PhysicsGrabbable : MonoBehaviour
    {
        ...
        public Action<Vector3, Vector3> Disc;
        ...
        public void ApplyVelocities(Vector3 linearVelocity, Vector3 angularVelocity)
        {
            ...
            _linearVelocity = linearVelocity; // 선속도 : 이동 속도
            _angularVelocity = angularVelocity; // 각속도 : 회전 속도
        }
        ...
        private void FixedUpdate()
        {
            if (_hasPendingForce)
            {
                ...
                this.Disc(_linearVelocity, _angularVelocity);
            }
        }
